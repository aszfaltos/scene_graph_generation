...
# Multiscale ROI Feature Extractor options
# Use FEATURE_EXTRACTOR: "MultiscaleROIFeatureExtractor" to enable
_C.MODEL.ROI_BOX_HEAD.MULTISCALE_POOLER_SCALES = [(1.0 / 16,), (1.0 / 32,)]
_C.MODEL.ROI_BOX_HEAD.MULTISCALE_BASE_EXTRACTOR = "FPN2MLPFeatureExtractor"
# Fusion options: "sum", "mean", "concat", "attention", "max"
_C.MODEL.ROI_BOX_HEAD.MULTISCALE_FUSION = "sum"
...
_C.MODEL.ROI_RELATION_HEAD.EMBEDDING_TYPE = "glove"  # Options: "glove", "word2vec", "bert", "minilm", "none"
...
# the dimension of relation head to extract the union features
...
# PCE (Predicate Confidence Estimation) for IMP
_C.MODEL.ROI_RELATION_HEAD.IMP_MODULE.RELATION_CONFIDENCE_AWARE = False

_C.MODEL.ROI_RELATION_HEAD.IMP_MODULE.APPLY_GT = False

_C.MODEL.ROI_RELATION_HEAD.IMP_MODULE.MP_ON_VALID_PAIRS = False  # hard filtering: only MP on filtered edges

_C.MODEL.ROI_RELATION_HEAD.IMP_MODULE.MP_VALID_PAIRS_NUM = 200  # top-k pairs for hard filtering

_C.MODEL.ROI_RELATION_HEAD.IMP_MODULE.ITERATE_MP_PAIR_REFINE = 1  # number of PCE refinement iterations

_C.MODEL.ROI_RELATION_HEAD.IMP_MODULE.RELNESS_MP_WEIGHTING = False  # soft weighting by confidence

# Options: "minmax", "learnable_scaling", "sigmoid_scaling", "polynomial_scaling"
_C.MODEL.ROI_RELATION_HEAD.IMP_MODULE.RELNESS_MP_WEIGHTING_SCORE_RECALIBRATION_METHOD = "minmax"

_C.MODEL.ROI_RELATION_HEAD.IMP_MODULE.LEARNABLE_SCALING_WEIGHT = (2.5, 0.03)  # (alpha, beta)

_C.MODEL.ROI_RELATION_HEAD.IMP_MODULE.SHARE_RELATED_MODEL_ACROSS_REFINE_ITER = False
...
# Options: "minmax", "learnable_scaling", "sigmoid_scaling", "polynomial_scaling"
_C.MODEL.ROI_RELATION_HEAD.BGNN_MODULE.RELNESS_MP_WEIGHTING_SCORE_RECALIBRATION_METHOD = "minmax"
...
# Fusion
_C.MODEL.ROI_RELATION_HEAD.CAUSAL.FUSION_TYPE = 'sum'  # features  # gate
...
# the features in pairwise relationship features
...
_C.MODEL.ROI_RELATION_HEAD.REL_PROP = [0.01858, 0.00057, 0.00051, 0.00109, 0.00150, 0.00489, 0.00432, 0.02913, 0.00245,
                                       0.00121,
                                       0.00404, 0.00110, 0.00132, 0.00172, 0.00005, 0.00242, 0.00050, 0.00048, 0.00208,
                                       0.15608,
                                       0.02650, 0.06091, 0.00900, 0.00183, 0.00225, 0.00090, 0.00028, 0.00077, 0.04844,
                                       0.08645,
                                       0.31621, 0.00088, 0.00301, 0.00042, 0.00186, 0.00100, 0.00027, 0.01012, 0.00010,
                                       0.01286,
...
# for detection mode, need to set as false, otherwise there may have some prediction been missed
